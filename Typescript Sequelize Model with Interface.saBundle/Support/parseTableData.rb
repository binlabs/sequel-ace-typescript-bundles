...
data_type_blob = "type: DataTypes.BLOB"
data_type_boolean = "type: DataTypes.BOOLEAN"
data_type_date = "type: DataTypes.DATE"
data_type_date_only = "type: DataTypes.DATEONLY"
...
data_type_geometry = "type: DataTypes.GEOMETRY"
...
data_type_real = "type: DataTypes.REAL"
data_type_string = "type: DataTypes.STRING"
data_type_time = "type: DataTypes.TIME"
...
CSV.parse(csv_data, headers: true)  do |row|
  ...
  dataType = data_type_blob if row['Type'].include? "binary"
  dataType = data_type_blob if row['Type'].include? "blob"
  dataType = data_type_time if row['Type'].include? "time"
  dataType = data_type_date_only if row['Type'].include? "date"
  dataType = data_type_date if row['Type'].include? "year"
  dataType = data_type_date if row['Type'].include? "timestamp"
  ...
  dataType = data_type_real if row['Type'].include? "real"
  dataType = data_type_decimal if row['Type'].include? "numeric"
  dataType = data_type_boolean if row['Type'].include? "bit"
